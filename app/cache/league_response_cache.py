...
_ENDPOINT_PAYLOAD_VERSION: Dict[str, str] = {
    ...
    "get_game_team_details": "lineup-densify-v3",
    "get_data_oddities": "roster-kpis-v2",
    ...
    "home_stats": "landing-v3",
    "get_latest_events": "latest-events-v1",
    "get_team_vs_team_comparison": "matchup-nav-v1",
    "get_club_matrix": "matrix-pos-v2",
    "get_club_legends": "club-legends-v5-neu-ulm-alias",
    "get_club_player_results": "club-player-results-v4-neu-ulm-alias",
    "get_club_rankings": "club-rankings-v5-neu-ulm-alias",
    ...
    "get_tournament_field_progress": "field-progress-chart-cap-v6",
    ...
    "get_tournament_podiums": "tournament-podiums-v3-tournament-average",
    "get_player_tournament_results": "player-tournament-results-v2",
    "get_tournament_player_catalog": "tournament-player-catalog-v2",
    "get_available_players": "tournament-round-players-v2",
    "get_available_leagues": "metadata-index-v1",
    "get_season_timetable": "venue-canonical-v1",
    "team_get_teams": "metadata-index-v1",
    "player_search": "player-catalog-v4-legacy-edv-remap",
    "player_get_available_seasons": "player-subset-v4-legacy-edv-remap",
    "get_lifetime_stats": "player-lifetime-v5-legacy-edv-remap",
    "get_highest_individual_games": "player-highest-games-v4-legacy-edv-remap",
    "get_club_300": "player-club-300-v4-legacy-edv-remap",
}
