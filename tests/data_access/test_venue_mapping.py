...
def test_canonicalize_known_aliases() -> None:
    ...
    assert canonicalize_venue_label("Dream-Bowl-Palace", lookup) == "Unterföhring Dreambowl Palace"
    assert canonicalize_venue_label("Dream-Bowl München", lookup) == "Unterföhring Dreambowl Palace"
